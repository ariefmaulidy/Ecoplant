    	  ...
    	  <div class="content_bottom">
    	    <div class="wrap">
    	    		...
    	    		<div class="categories">
						   <ul>
						  	   <h3>Menu ADMIN</h3>
							      ...
							      <li><a href="tambah.php">Tambah Tanamanan</a></li><li><a href="hapus.php">Hapus Tanamanan</a></li>
				...
				<div class="row">
					...
					$kueri=mysqli_query($connect,"select * from pemesanan where status_pembayaran=0 limit $limit,10");
					...
					<div class="row">
						...
						<div style="float:right"><img src="images/<?php $nama=$hasil['tanaman'];
														$qry=mysqli_query($connect,"select * from tanaman where nama_tanaman='$nama'");
														$result=mysqli_fetch_array($qry,MYSQLI_ASSOC);
														echo $result['gambar']?>" class="circle z-depth-3" height="100px" width="100px"></img></div>
						<p>
						<h5>Nama Pemesan : <?php echo $hasil['nama_pemesan']?></h5>
						<h5>Alamat Tujuan : <?php echo $hasil['alamat_pemesan']?></h5>
						<h5>Jumlah yang dipesan: <?php echo $hasil['banyak_pesanan']?></h5>
						<h5>Total yang harus dibayar: <?php echo $hasil['total_harga'] ?></h5>
						<br><br>
						<a href="verifproses.php?id=<?php echo $hasil['id_pemesanan']?>" class="waves-effect waves-light btn right orange darken-4">Konfirm</a>
						<br><br>
						</p> 
            </div>
          </div>
