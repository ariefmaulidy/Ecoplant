<?php
	include'header.php';
?>
	<title>ECO Plant </title>
   	<div class="header">
  	  		<div class="wrap">
				<div class="header_bottom">
			   <div class="slider-text">
			   	<h2>ECO PLANT</h2>
			   	<p>Bingung mencari tanaman ?<br>
			   	  di sini tempatnya :)<br>
			   	berbagai macam tanaman tersedia disini, tinggal cari apa yang menurut anda cocok dengan anda</p>
	  	      </div>
	  	      <div class="slider-img">
	  	      	<img src="images/tanamanhias.jpg" alt="" />
	  	      </div>
	  	     <div class="clear"></div>
	      </div>
		</div>
    	  ...
    	  <div class="content_bottom">
    	    <div class="wrap">
    	    		...
    	    		<div class="categories">
						   <ul>
						  	   <h3>Browse All Categories</h3>
							      ...
							      <li><a href="kair.php">Tanamn Air</a></li>
				...
				<div class="row">
					...
					$kueri=mysqli_query($connect,"select * from tanaman order by id_tanaman desc limit $limit,12");
